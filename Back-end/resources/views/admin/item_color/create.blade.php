...
@section('content')
    <div id="basic" class="col-lg-12 col-sm-12 col-12 layout-spacing">
        <form action="{{ route('admin.item_color.store') }}" method="POST">
            @csrf
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            id="sName" placeholder="{{ __('general.common.name') }}" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="form-group mb-4">
                        ...
                        @enderror
                        <input type="hidden" name="value" placeholder="Color" value="{{ old('value') }}">
                    </div>
                    <div class="form-group mb-4">

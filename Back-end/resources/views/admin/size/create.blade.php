...
@section('content')
    <div id="basic" class="col-lg-12 col-sm-12 col-12 layout-spacing">
        <form action="{{ route('admin.item_size.store') }}" method="POST">
            @csrf
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="value" class="form-control @error('value') is-invalid @enderror"
                            id="sValue" placeholder="{{ __('general.common.value') }}" value="{{ old('value') }}">
                        @error('value')
                    ...
                    <div class="form-group mb-4">
                        <label for="sItemCategory">{{ __('general.common.category') }}</label>
                        <div>
                            <select class="selectpicker w-100 @error('item_category_id') is-invalid @enderror"
                                id="sItemCategory" title="Choose category" name="item_category_id" data-live-search="true">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div>
                            <select class="selectpicker w-100 @error('item_person_type_id') is-invalid @enderror"
                                id="sItemPersonType" title="Choose person type" name="item_person_type_id"
...
@push('script')
    <script>
        $('#sItemCategory').selectpicker('val', '{{ @old('item_category_id') }}');
        $('#sItemPersonType').selectpicker('val', '{{ @old('item_person_type_id') }}');
    </script>
@endpush

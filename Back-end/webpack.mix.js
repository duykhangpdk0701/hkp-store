...
mix.sass('resources/sass/assets/structure.scss', 'public/assets/css/')
    ...
    .sass('resources/sass/assets/apps/invoice-add.scss', 'public/assets/css/apps')
    .sass('resources/sass/assets/apps/invoice-edit.scss', 'public/assets/css/apps')
    .sass('resources/sass/assets/apps/invoice-list.scss', 'public/assets/css/apps')
    .sass('resources/sass/assets/apps/invoice-preview.scss', 'public/assets/css/apps')
